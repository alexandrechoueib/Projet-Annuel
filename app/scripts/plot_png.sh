...
for treatment in $treatments ; do
	...
	echo "set output \"results/plots/${cpu_name}/${my_arch}/${my_comp}/${cpu_name}_${my_syst}_${my_comp}_${my_arch}_${treatment}.png\"" >>$output
	echo "set terminal png medium size 800,600" >>$output
