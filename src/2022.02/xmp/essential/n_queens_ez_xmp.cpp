...
/*
   @WHAT
     Try to place a queen at the given row.
 
   @HOW
     We recursively call this function with
     @param=queen=1 and then @param:queen+1.
     
   @PARAMETERS
     @param:queen queen to place (also row)
     
 */
void place( integer queen ) {

	// if we have reached the number of queens to place
