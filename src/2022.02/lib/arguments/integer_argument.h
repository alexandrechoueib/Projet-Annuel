...
#ifndef ARGUMENTS_INTEGER_ARGUMENT_H_
#define ARGUMENTS_INTEGER_ARGUMENT_H_
...
public:
	IntegerArgument( string long_label, char short_label, integer *value,
...
#endif /* ARGUMENTS_INTEGER_ARGUMENT_H_ */
