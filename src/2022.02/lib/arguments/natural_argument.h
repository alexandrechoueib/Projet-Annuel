...
#ifndef ARGUMENTS_NATURAL_ARGUMENT_H_
#define ARGUMENTS_NATURAL_ARGUMENT_H_
 ...
 */
class NaturalArgument : public Argument {
protected:
	natural *_value;

public:
	NaturalArgument( string long_label, char short_label, natural *value,
...
#endif /* ARGUMENTS_NATURAL_ARGUMENT_H_ */
