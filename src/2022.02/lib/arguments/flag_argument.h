...
#ifndef ARGUMENTS_FLAG_ARGUMENT_H_
#define ARGUMENTS_FLAG_ARGUMENT_H_
...
public:
	...
	FlagArgument( string long_label, char short_label, bool *value,
...
#endif /* ARGUMENTS_FLAG_ARGUMENT_H_ */
