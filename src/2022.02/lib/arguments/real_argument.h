...
#ifndef ARGUMENTS_REAL_ARGUMENT_H_
#define ARGUMENTS_REAL_ARGUMENT_H_
 ...
 */
class RealArgument : public Argument {
protected:
	real *_value;

public:
	RealArgument( string long_label, char short_label, real *value,
...
#endif /* ARGUMENTS_REAL_ARGUMENT_H_ */
