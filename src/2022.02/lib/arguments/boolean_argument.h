...
#ifndef ARGUMENTS_BOOLEAN_ARGUMENT_H_
#define ARGUMENTS_BOOLEAN_ARGUMENT_H_
...
public:
	 ...
	 */
	BooleanArgument( string long_label, char short_label, bool *value,
...
#endif /* ARGUMENTS_BOOLEAN_ARGUMENT_H_ */
